...
export const originZoom = 17; // Starting Zoom level for the Web Map
export const nearmapMinZoom = 17; // Nearmap Imagery Lowest resolution zoom level the user can view
